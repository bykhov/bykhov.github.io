...
* [skpro](https://github.com/sktime/skpro) - probabilistic forecasting
...
* [mlxtend](https://rasbt.github.io/mlxtend/) - Machine learning extensions, including feature selection methods such as Sequential Feature Selector (SFS) and Exhaustive Feature Selector (EFS), and more.
