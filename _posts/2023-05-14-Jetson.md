...
* Speed-up by TensorRT is required.  I have even taken a free project on Coursera ([certificate](https://coursera.org/share/678fc097e9f7fb2e99b11a569bb6cb08), [review](https://bykhov.github.io/posts/tensorrt_course/) and somewhat inspected a similar [course](https://courses.nvidia.com/courses/course-v1:DLI+L-FX-18+V2/course/) by Nvidia (that is free for me as an academic ambassador). Still waiting to apply, it can be an important subject to present to students in the future, not just in the Jetson Nano context.
