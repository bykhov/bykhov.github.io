...
* [Classify Images with TensorFlow on Google Cloud](https://www.cloudskillsboost.google/course_templates/646) (7 hours, 15', 26 credits)
...
The CPOC appointment involves obligatory training and requires an institutional license agreement (non-trivial bureaucracy).
  * Without CPOC, it is impossible to assess the resources. Even detailed syllabi are unavailable.
  Note, I am CPOC at my institution.
...
Cons:
* The material is mostly technical (hands-on only, without theory) and less appropriate for programming skills.
...
[^2]: Some GCP resources are not assessable without credits.
