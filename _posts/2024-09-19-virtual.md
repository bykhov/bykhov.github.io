...
My goal is to provide students with free educational resources for a machine learning or deep learning courses. 
...
* Trivial badge requirements; user can pass the badge by clicking through the material without any understanding; rudimentary quizzes.
...
Procs:
* Visually pleasant
* Experince with a "real" virtual machine enviroment.
...
#### Virtualization resources
* The free resources from each provider are sufficient for tens to hundreds of hours of GPU-enabled virtual machine with per hour billing.
...
#### IoT
* There is intensive cloud support for IoT, e.g. [AWS IoT](https://aws.amazon.com/iot/), [Azure IoT](https://azure.microsoft.com/en-us/services/iot-hub/), and [Google Cloud IoT](https://cloud.google.com/solutions/iot).
These resources are not covered in this post.
* Far less support for IoT in education.
...
* The quality and *free-ness* of these courses is not covered in this post.
