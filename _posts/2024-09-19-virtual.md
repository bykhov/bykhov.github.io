...
### Additional (free) MOOC resources:
...
* [University of Helsinki MOOC Center](https://www.mooc.fi/en/)
  ...
  * [Customized courses](https://www.mooc.fi/en/teachers/) per teacher are available (programming courses only).
    * I am customizable course coordinator for our institution.
...
* [Matlab Academy](https://matlabacademy.mathworks.com/)
    * Free courses on different topics, including ML and DL.
